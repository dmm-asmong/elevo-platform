...
export const courses: Course[] = [
  ...
  {
    slug: "ai-shorts-creator",
    title: "AI로 숏폼 만들기",
    description: "기획부터 완성까지, AI 3종 세트로 90분 만에 나만의 숏폼 영상 완성",
    icon: "🎬",
    color: "#FF0050",
    sessions: 1,
    status: "active",
    tags: ["ChatGPT", "Gemini", "Google Flow", "Vrew"],
  },
  {
    slug: "shortform-workshop",
    title: "AI + Vrew 숏폼 특강",
    description: "ChatGPT·Gemini로 대본을 쓰고, AI 이미지를 만들고, Vrew로 영상을 완성하는 90분 완성 특강",
    icon: "🐱",
    color: "#F59E0B",
    sessions: 1,
    status: "active",
